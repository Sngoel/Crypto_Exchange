...
def insert_into_orders(order_info):
    ...
    cur.execute("INSERT INTO open_orders ( coin_id_out, coin_id_in, ordertype ,amount_out, amount_in) VALUES( %s, %s,%s, %s, %s);" ,( coin_id_out,coin_id_in,ordertype,amount_out,amount_in))
